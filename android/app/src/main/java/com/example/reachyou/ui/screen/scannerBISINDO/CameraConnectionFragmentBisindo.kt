...
class CameraConnectionFragmentBisindo private constructor(
    ...
    /** Opens the camera specified by [CameraConnectionFragmentBisindo.cameraId].  */
    ...
    companion object {
        ...
        fun newInstance(
            ...
            layout: Int,
            inputSize: Size): CameraConnectionFragmentBisindo {
            return CameraConnectionFragmentBisindo(callback, imageListener, layout, inputSize)
        }
    }
}