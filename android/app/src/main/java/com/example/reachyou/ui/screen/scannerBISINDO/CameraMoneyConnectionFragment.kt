...
class CameraMoneyConnectionFragment private constructor(
    ...
    /** Opens the camera specified by [CameraMoneyConnectionFragment.cameraId].  */
    ...
    companion object {
        ...
        fun newInstance(
                ...
                layout: Int,
                inputSize: Size): CameraMoneyConnectionFragment {
            return CameraMoneyConnectionFragment(callback, imageListener, layout, inputSize)
        }
    }
}
